...
from util.vocab import RemiVocab, DescriptionVocab
from util.constants import PAD_TOKEN, EOS_TOKEN, BAR_KEY, POSITION_KEY
...
class Seq2SeqModule(nn.Module):
    ...
    def get_loss(self, batch, device, return_logits=False):
